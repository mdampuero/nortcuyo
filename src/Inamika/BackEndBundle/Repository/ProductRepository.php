...
class ProductRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function setUpdate(){
        ...
        $delete = $em->createQuery('update InamikaBackEndBundle:Product e set e.isDelete = 1 WHERE e.isUpdate = 0');
        $delete->execute();
        
        $update = $em->createQuery('update InamikaBackEndBundle:Product e set e.isUpdate = 0');
        $update->execute();
